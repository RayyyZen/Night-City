...
router.post('/', limiter, deviceValidators.createDeviceValidation, validate, userMiddlewares.auth, userMiddlewares.cantCreateDevice, deviceController.createDevice)
router.put('/:id', userMiddlewares.auth, userMiddlewares.cantCreateDevice, deviceController.updateDevice)
